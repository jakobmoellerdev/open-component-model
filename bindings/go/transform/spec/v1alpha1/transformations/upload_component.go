...
func (t *UploadComponentTransformation) Transform(ctx context.Context, credentialProvider credentials.GraphResolver) (map[string]any, error) {
...
func (t *UploadComponentTransformation) NewDeclType(nestedFieldTypes map[string]runtime.Type) (*jsonschema.DeclType, error) {
