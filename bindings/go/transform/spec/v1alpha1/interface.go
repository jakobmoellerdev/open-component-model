...
type Transformation interface {
	...
	NewDeclType(nestedTypedFields map[string]runtime.Type) (*jsonschema.DeclType, error)
	FromGeneric(generic *GenericTransformation) error
	Transform(ctx context.Context, credentialProvider credentials.GraphResolver) (map[string]any, error)
}
