...
func ParseSchemalessResource(resource map[string]interface{}) ([]FieldDescriptor, error) {
...
func parseSchemalessResource(resource interface{}, path string) ([]FieldDescriptor, error) {
